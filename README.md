...
All the icons (such as buttons & notes) are from https://material-ui.com/

### Google Fonts
You can get various font styles from https://fonts.google.com/


## Docker
Build the Docker image with (note the dot at the end): docker build -t test-app:dev .
...
Build the image and start container via compose file with:
